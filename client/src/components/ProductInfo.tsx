...
interface ProductInfoProps {
  ...
  handleLike: (event: React.MouseEvent<HTMLElement>) => Promise<void>;
  handleAddToCart: (event: React.MouseEvent<HTMLElement>) => Promise<void>;
  isLike: boolean;
}
    ...
    <section className="text-gray-700 body-font overflow-hidden bg-white">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img
            alt="ecommerce"
            className="max-h-96 object-contain lg:w-1/2 w-full object-center rounded border border-gray-200"
            src={product.image}
          />
